...
const Docs =() =>{
    ...
    <>
      ...
      <p className='url-base'>
        ...
        <a href='https://back-dragon-ballzs-production.up.railway.app/api'>https://back-dragon-ballzs-production.up.railway.app/api</a>
        </p>
      ...
      <p className="code-vista" data-language="shell">
        <span className="endpoint">
          <span className="request">GET </span>https://back-dragon-ballzs-production.up.railway.app/api</span></p>
